...
CROSSVIT_RAY_CONFIG = {
    ...
    "channels": 1,
    "network_config": {
        "depth": tune.randint(3, 6),  # number of multi-scale encoding blocks
        "sm_dim": 128,  # high res dimension
        "sm_patch_size": 16,  # high res patch size (should be smaller than lg_patch_size)
        "sm_enc_depth": 4,  # high res depth
        "sm_enc_heads": 2,  # high res heads
        ...
        "lg_enc_heads": 2,  # low res heads
        "lg_enc_mlp_dim": 128,  # low res feedforward dimensions
        "cross_attn_depth": tune.randint(1, 3),  # cross attention rounds
        "cross_attn_heads": tune.randint(2, 6),  # cross attention heads
