    ...
    **kwargs: Any
    ...
    if transformer_type == "CCT":
        ...
        model = CvT(
            ...
            s3_emb_dim=kwargs["s3_emb_dim"],  
            s3_emb_kernel=kwargs["s3_emb_kernel"],
            s3_emb_stride=kwargs["s3_emb_stride"],
            s3_proj_kernel=kwargs["s3_proj_kernel"],
            s3_kv_proj_stride=kwargs["s3_kv_proj_stride"],
            s3_heads=kwargs["s3_heads"],
            s3_depth=kwargs["s3_depth"],
            s3_mlp_mult=kwargs["s3_mlp_mult"],
