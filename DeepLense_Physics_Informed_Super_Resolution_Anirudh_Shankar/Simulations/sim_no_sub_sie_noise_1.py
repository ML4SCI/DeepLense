...
for i in tqdm(range(num_sim)):
    ...
    np.save('/home/anirudh/Documents/GSoC/LensSR/Simulations/data_model_1/no_sub_sie_noise/no_sub_sie_noise_sim_%d'%i,File)
    lens.simple_sim(150,0.025)
    File = lens.image_real
    np.save('/home/anirudh/Documents/GSoC/LensSR/Simulations/data_model_1/no_sub_sie_noise_HR/no_sub_sie_noise_HR_sim_%d'%i,File)
lens = DeepLens()
lens.make_single_halo_SIE(1e12)
lens.make_no_sub()
lens.set_instrument('Euclid')
...
np.save('/home/anirudh/Documents/GSoC/LensSR/Simulations/data_model_1/no_sub_sie_noise/alpha',lens.alpha)
