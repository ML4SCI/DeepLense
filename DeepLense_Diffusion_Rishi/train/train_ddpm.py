    ...
    def train(
        ...
        for epoch in range(self.n_epochs):
            ...
            if (epoch+1) % self.plot_freq == 0: 
                ...
                self.diffusion.save_images(sampled_images, os.path.join("plots", f"ddpm_l1_{epoch}.jpg"))
                torch.save(self.model.state_dict(), os.path.join("saved_models",  f"ddpm_l1_{epoch}.pt"))
