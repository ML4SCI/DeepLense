# Code picked from https://github.com/dc250601/GSOC/blob/main/Swin_Hybrid/hybrid.py
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        assert 0 <= self.shift_size < self.window_size, f"shift_size {self.shift_size} must in range [0, window_size] i.e. [0, {self.window_size}]"
...
#----------------------------------------------------------------------------------------------------- 
class effnet_embedding(nn.Module):
    #Hybrid patch embedding layer
    def __init__(self, embed_dim, norm_layer = None):
        ...
        self.block_top = nn.Sequential(nn.Conv2d(1,
                                                 ...
                                                 padding=(1, 1),
                                                 bias=False),
                                       *list(self.base.children())[1:3])
        
        self.main_block = list(self.base.children())[3]
        
        self.body = nn.Sequential(*list(self.main_block.children())[0:4])
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.patch_embed = effnet_embedding(embed_dim=embed_dim,
